...
phpimagealbum.routines={
	...
	buildimage:function(albumvar, i, desc, showorder){
		...
		return (showorder? '<b style="color:red">Source Order: '+albumvar.images[i][0]+'</b><br />' : '') + '<img src="' + albumvar.baseurl + albumvar.images[i][1] + '" data-index="' + i +'" />' + (albumvar.images[i][3]? '<br />'+albumvar.images[i][4] : (desc)? desc : '')
	},
